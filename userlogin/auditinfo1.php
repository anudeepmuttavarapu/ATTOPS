...
*/
 ...
 var xhr=new createXHR();
              ...
              xhr.open("GET","audit_php.php?MDN_Number=" +mdn+"&Date=" +Date +"&eDate=" +eDate+ "&POC_Category=" +poc,true);
...
<div id="header">
		...
		<tr>
			...
			<td>
				<button type="button" onClick="am()">AuditLogs Stats</button>
			</td>
...
<option value="POC15P">POC15</option>
			...
			<form>
				...
				<textarea id="MDN_Number" placeholder="Enter the MDN's"></textarea>
...
<option value="POC16">POC16</option>
                                ...
                                <div>
                                        <button type="button" onclick=" f2(MDN_Number,Date,eDate,POC_Category);">GetCDR</button>
