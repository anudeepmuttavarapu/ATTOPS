 ...
 */
 ...
 xhr.open("GET","audit_php.php?MDN_Number2=" +mdn2+"&Date=" +Date+"&eDate=" +eDate+ "&POC_Category2=" +poc2,true);
...
<option value="POC15P">POC15</option>        
                                ...
                                <div>
                                        <button type="button" onclick=" f2(MDN_Number2,Date,eDate,POC_Category2);">Get Audit stats</button>
